...
public class DharmDelListingAdapter extends RecyclerView.Adapter<DharmDelListingAdapter.ContactHolder> {
    ...
    @Override
    public DharmDelListingAdapter.ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());

        // Inflate the layout view you have created for the list rows here
        View view = layoutInflater.inflate(R.layout.item_product_list, parent, false);
        return new DharmDelListingAdapter.ContactHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull DharmDelListingAdapter.ContactHolder holder, final int position) {
